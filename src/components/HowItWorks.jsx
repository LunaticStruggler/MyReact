  ...
  return (
    <section className={`how-it-works ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="phones-container">
        <img src="public/Images/Phones/leftphon.png" alt="Phone Left" className="phone phone-left" />
        <img src="public/Images/Phones/midphone.png" alt="Phone Center" className="phone phone-center" />
        <img src="public/Images/Phones/rightphone.png" alt="Phone Right" className="phone phone-right" />
      </div>
