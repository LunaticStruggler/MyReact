    ...
    <section className={`hero ${darkMode ? 'dark-mode' : ''}`}>
      <div className="hero-text">
        ...
        <div className="app-buttons">
          <a href="#"><img src="public/Images/Miscellaneous/appstore.png" alt="App Store" /></a>
          <a href="#"><img src="public/Images/Miscellaneous/playstore.png" alt="Google Play" /></a>
        </div>
        <div className="discover-more-container">
          <a href="#" className="discover-more">
            <img src="public/Images/Icons/button.png" alt="Arrow" />
          </a>
          <span className="discover-text">Discover more</span>
        </div>
      </div>
      <div className="hero-image">
        <img src="public/Images/Phones/correctphone.png" alt="App Preview" />
      </div>
    </section>
  );
}
